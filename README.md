...
local Window = OrionLib:MakeWindow({Name = "Kiev Script", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Kiev Script"})
...
W:AddLabel("[+] Kiev Script is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Kiev Script(Noitification)",
